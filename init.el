...
(use-package editorconfig
  ...
  :config (progn
            ...
            (add-to-list 'editorconfig-indentation-alist '(js-mode js-square-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js-mode js-switch-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-mode js2-basic-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-mode js-curly-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-mode js-expr-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-mode js-paren-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-mode js-square-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-mode js-switch-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-minor-mode js2-basic-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-minor-mode js-curly-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-minor-mode js-expr-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-minor-mode js-paren-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-minor-mode js-square-indent-offset))
            (add-to-list 'editorconfig-indentation-alist '(js2-minor-mode js-switch-indent-offset))
